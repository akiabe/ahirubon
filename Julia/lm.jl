...
# ╔═╡ aa95c608-be1c-11ec-008b-d39e07e93e4b
begin
	using CSV
	using DataFrames
end

# ╔═╡ ccbf7625-9a55-47b9-a03e-f8f6742e9be4
using Plots

# ╔═╡ dc41fe46-58c2-4b9c-bc60-d2c82ccc090c
begin
	using Turing
	using StatsPlots
	using MCMCChains
...
# ╔═╡ b4bd4094-af12-4fd5-8144-cb549b7323e6
begin
	d = CSV.read("data-salary.txt", DataFrame)
	describe(d)
end

# ╔═╡ 3c84ee50-4842-4b03-8bbd-d939bedac49c
scatter(d.X, d.Y, xlab="X", ylab="Y", label=:none)

# ╔═╡ 184f9e62-645b-4f5a-85f1-7835bdf9b380
@model function linear_regression(X, Y)
	...
	for n in 1:N
		Y[n] ~ Normal(a + b*X[n], σ)
	end
end

# ╔═╡ 4a6e2fd0-ae55-48a9-9ed4-f01ee6f6c2e3
model = linear_regression(d.X, d.Y)

# ╔═╡ 07e45fb3-344c-42ac-a66b-1e23066bb277
chain = sample(model, NUTS(), 2000);

# ╔═╡ 203bb57c-344f-4aee-ad66-98b368c9264e
plot(chain)

# ╔═╡ 8f34342a-6ec8-4e13-8375-317fc22d3b70
describe(chain)[1]

# ╔═╡ 7e4088f9-3889-4d2c-8304-e64666fcbbb7
describe(chain)[2]

# ╔═╡ f6020048-f1c9-4e57-a0f6-bb26918c89ad
collect(range(minimum(d.X), maximum(d.X), length=100))

# ╔═╡ 0c33a396-8dad-4014-8124-0d1d4b95d74d


# ╔═╡ f44c0500-a1cb-421c-b4bc-77ee7fd9bf32


# ╔═╡ 341fe1f1-480e-49c9-b208-455bc384dea7
